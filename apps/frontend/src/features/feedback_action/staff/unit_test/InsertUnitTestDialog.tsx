...
export interface InsertUnitTestDialogProps {
    block: Block;
    action: Action;
    open: boolean;
    beforeIndex: number;
...
export function InsertUnitTestDialog(props: InsertUnitTestDialogProps) {
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)}>
                <DialogTitle>{t("assignment:titleInsertUnitTest")}</DialogTitle>
                <DialogContent>
                    <Grid container spacing={2} direction="column">
                        <Grid item>
                            <Typography>
                                {t("assignment:bodyInsertUnitTest")}
                            </Typography>
                        </Grid>
                        <Grid item>
                            <TextFieldController
