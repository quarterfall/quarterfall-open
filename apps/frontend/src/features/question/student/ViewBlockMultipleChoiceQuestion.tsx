...
interface ViewBlockMultipleChoiceQuestionProps {
...
export function ViewBlockMultipleChoiceQuestion(
    props: ViewBlockMultipleChoiceQuestionProps
) {
    const {
        assignment,
        block,
        ...
        if (!block.multipleCorrect) {
            ...
            const newAnswer =
                answer.indexOf(choice.id) >= 0
                    ...
                    : answer.concat(choice.id).filter((a) => a !== null);
            setAnswer(newAnswer);
