...
type EditCourseAnalyticsBlockPageProps = {
    course: Course;
    analyticsBlock: AnalyticsBlock;
};

export const EditCourseAnalyticsBlockPage = (
    props: EditCourseAnalyticsBlockPageProps
) => {
    const { course, analyticsBlock } = props;
